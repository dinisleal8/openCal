...
export default function Security(props: Props) {
    ...
    return (
        <>
            ...
            <h1 className="sr-only">{t('settings.securityTitle')}</h1>

            <div className="space-y-6">
                <Heading
                    variant="small"
                    title={t('settings.securityPasswordHeading')}
                        ...
                        <>
                            <div className="grid gap-2">
                                ...
                                <PasswordInput
                                    ...
                                    placeholder={t(
                                        'settings.securityCurrentPassword',
                                    )}
                                />
                            ...
                            <div className="grid gap-2">
                                ...
                                <PasswordInput
                                    ...
                                    autoComplete="new-password"
                                    placeholder={t(
                                        'settings.securityConfirmPassword',
                                    )}
                                    passwordrules={props.passwordRules}
                                />
